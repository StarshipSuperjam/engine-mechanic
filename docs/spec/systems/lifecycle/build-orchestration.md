...
*Settled in the design workspace on 2026-07-11, ratified by [decision 0293](../../../adr/0293-resolve-re-lock-build-orchestration-roster-divergence-hunter.md).*
...
### Validate before the expensive review; rerun validation, not the audit
